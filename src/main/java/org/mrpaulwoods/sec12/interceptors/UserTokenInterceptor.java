...
/*
    ...
    user-token-3, user-token-4 => standard users, server stream calls are NOT allowed. other calls are allowed.
    any other token => not allowed
 */
public class UserTokenInterceptor implements ServerInterceptor {

    private static final Logger log = org.slf4j.LoggerFactory.getLogger(UserTokenInterceptor.class);
